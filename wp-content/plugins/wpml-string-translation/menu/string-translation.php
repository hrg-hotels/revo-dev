	...
	<div class="tablenav icl-st-tablenav js-icl-st-tablenav">
		...
		selected="selected"<?php endif; ?>><?php echo $v; ?></option>
											...
											<div class="select-and-button-button">
												<a href="#"<?php echo esc_html__( 'New', 'wpml-string-translation' ); ?> id="icl_st_importpo_newbutton">New</a>
												<a href="#" style="display: none"<?php echo esc_html__( 'select from existing', 'wpml-string-translation' ); ?> id="icl_st_importpo_existingbutton">Select from existing</a>
											</div>
										</div>
										<?php endif; ?>
									</div>
